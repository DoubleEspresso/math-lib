...
namespace Math
{
  class Matrix
  {
    ...
    template<typename T> static void ge_axb_cpu(T * a, T * b, const int N);
    template<typename T> static void ge_axb_cpu_tri(T * a, T * b, const int N);
    //template<typename T> static void lu_cpup(T * a, T * b, int * p, const int N);
    //template<typename T> static void lu_gpu(T * a, T * b, int * p, const int N);
    //template<typename T> static void lu_task(void * p);
  ...
  public:
    ...
    static MATHLIB_API void ge_axb(double * a, double * b, const int N, bool tri= false, bool gpu = false);
    static MATHLIB_API void ge_axb(float * a, float * b, const int N, bool tri = false, bool gpu = false);
    static MATHLIB_API void ge_axb(int * a, int * b, const int N, bool tri = false, bool gpu = false);
    static MATHLIB_API void ge_axb(char * a, char * b, const int N, bool tri = false, bool gpu = false);
  ...
  extern "C" template void Matrix::lu_cpup(char * a, char * b, int * p, const int N);
  ...
  extern "C" template void Matrix::ge_axb_cpu(double * a, double * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu(float * a, float * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu(int * a, int * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu(char * a, char * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu_tri(double * a, double * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu_tri(float * a, float * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu_tri(int * a, int * b, const int N);
  extern "C" template void Matrix::ge_axb_cpu_tri(char * a, char * b, const int N);
